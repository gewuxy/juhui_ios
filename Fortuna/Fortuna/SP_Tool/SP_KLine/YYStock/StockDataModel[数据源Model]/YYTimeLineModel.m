...
- (NSString *)DayDatail {
    return _dict[@"minute"];//[NSString stringWithFormat:@"%02ld:%02ld",[_dict[@"minute"] integerValue]/60,[_dict[@"minute"] integerValue]%60];
}
...
- (BOOL)isShowTimeDesc {
    ...
    //||  [_dict[@"minute"] integerValue] == 780 
    return [_dict[@"minute"] integerValue] == 0 ||  [_dict[@"index"] integerValue] == 240;
}
