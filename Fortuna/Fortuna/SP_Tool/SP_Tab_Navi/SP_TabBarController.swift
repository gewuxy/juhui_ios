...
class SP_TabBarController: UITabBarController {
    ...
    //Storyboard
    override class func initSPVC() -> SP_TabBarController {
        return UIStoryboard(name: "Main", bundle: nil).instantiateViewController(withIdentifier: "SP_TabBarController") as! SP_TabBarController
    }
