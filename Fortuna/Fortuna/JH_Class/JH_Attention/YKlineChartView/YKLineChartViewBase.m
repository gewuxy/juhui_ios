...
- (void)drawLabelPrice:(CGContextRef)context
{
    ...
    //self.contentLeft - (self.leftYAxisIsInChart?0:sizeMaxPriceAttStr.width+2)
    CGRect maxPriceRect = CGRectMake(self.contentRight-sizeMaxPriceAttStr.width, self.contentTop, sizeMaxPriceAttStr.width, sizeMaxPriceAttStr.height);
    ...
    //self.contentLeft - (self.leftYAxisIsInChart?0:sizeMidPriceAttStr.width+2)
    CGRect midPriceRect = CGRectMake(self.contentRight-sizeMidPriceAttStr.width, ((self.uperChartHeightScale * self.contentHeight)/2.0 + self.contentTop)-sizeMidPriceAttStr.height/2.0, sizeMidPriceAttStr.width, sizeMidPriceAttStr.height);
    ...
    //self.contentLeft - (self.leftYAxisIsInChart?0:sizeMinPriceAttStr.width+2)
    CGRect minPriceRect = CGRectMake(self.contentRight-sizeMinPriceAttStr.width, ((self.uperChartHeightScale * self.contentHeight) + self.contentTop - sizeMinPriceAttStr.height ), sizeMinPriceAttStr.width, sizeMinPriceAttStr.height);
    ...
    // - (self.leftYAxisIsInChart?0:zeroVolumeAttStrSize.width+2)
    CGRect zeroVolumeRect = CGRectMake(self.contentRight-zeroVolumeAttStrSize.width, self.contentBottom - zeroVolumeAttStrSize.height, zeroVolumeAttStrSize.width, zeroVolumeAttStrSize.height);
    ...
    // - (self.leftYAxisIsInChart?0:maxVolumeAttStrSize.width+2)
    CGRect maxVolumeRect = CGRectMake(self.contentRight-maxVolumeAttStrSize.width, (self.uperChartHeightScale * self.contentHeight)+self.xAxisHeitht, maxVolumeAttStrSize.width, maxVolumeAttStrSize.height);
              ...
              lineWidth:(CGFloat)lineWidth
{
    ...
    [self drawLabel:context attributesText:leftMarkerStrAtt rect:CGRectMake(self.contentLeft,point.y - leftMarkerStrAttSize.height/2.0 - (leftMarkerStrAttSize.height)/2, leftMarkerStrAttSize.width, leftMarkerStrAttSize.height)];
    ...
    [self drawLabel:context attributesText:rightMarkerStrAtt rect:CGRectMake(self.contentRight - rightMarkerStrAttSize.width, point.y - rightMarkerStrAttSize.height/2.0, rightMarkerStrAttSize.width, rightMarkerStrAttSize.height)];
...
- (NSDictionary *)defaultAttributedDic
{
    if (!_defaultAttributedDic) {
        _defaultAttributedDic = @{NSFontAttributeName:[UIFont systemFontOfSize:8],NSBackgroundColorAttributeName:[UIColor clearColor]};
    }
