...
func makeKTimeLineData(_ type:JH_ChartDataType, timeLines:[M_TimeLine]) -> [M_TimeLine] {
    ...
    switch type {
    case .t分时:
        return makeTimeData(makeMidTimeData(data, component:.second, timeCountMax:600, timeNum: 600), component:.second, timeCountMax:600, timeNum: 600)
    case .t5日:
        return makeTimeData(makeMidTimeData(data, component:.second, timeCountMax:600, timeNum: 600), component:.second, timeCountMax:600, timeNum: 600)
    case .t日K:
        return makeTimeData(makeMidTimeData(data, component:.second, timeCountMax:3600*24, timeNum: 3600*24), component:.second, timeCountMax:3600*24, timeNum: 3600*24)
    case .t周K:
        return data
    case .t月K:
        return data
    case .t1分:
        return makeTimeData(makeMidTimeData(data, component:.second, timeCountMax:60, timeNum: 60), component:.second, timeCountMax:60, timeNum: 60)
    case .t5分:
        return makeTimeData(makeMidTimeData(data, component:.second, timeCountMax:60*5, timeNum: 60*5), component:.second, timeCountMax:60*5, timeNum: 60*5)
    case .t10分:
        return makeTimeData(makeMidTimeData(data, component:.second, timeCountMax:600, timeNum: 600), component:.second, timeCountMax:600, timeNum: 600)
    case .t30分:
        return makeTimeData(makeMidTimeData(data, component:.second, timeCountMax:30*60, timeNum: 30*60), component:.second, timeCountMax:30*60, timeNum: 30*60)
    case .t60分:
        return makeTimeData(makeMidTimeData(data, component:.second, timeCountMax:3600, timeNum: 3600), component:.second, timeCountMax:3600, timeNum: 3600)
    }
    //return data
}
//MARK:--- 处理中间分时数据 -----------------------------
